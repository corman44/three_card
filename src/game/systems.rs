...
pub fn rx_other_players(
    ...
    for (id, mut msg) in room.receive() {
        match msg.action {
            ActionType::PickupPile => {
                info!("PickupPile Rx'd from: {:?}", id);
